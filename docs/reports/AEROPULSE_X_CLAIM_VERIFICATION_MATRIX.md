...
| **13** | **RUL Step Monotonicity Rate** | 97.01% | **97.01%** | 1,137 Sequential Time Steps | Discontinuous Baseline (81.2%) | **REPRODUCED** | `SYNTHETIC-ONLY` | Monotone trajectory constraint without upward jumps. |
