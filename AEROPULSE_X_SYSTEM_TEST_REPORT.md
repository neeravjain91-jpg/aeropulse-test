...
| :--- | :--- | :--- | :--- |
| **Automated Test Suite** | 100% pass rate | **84 / 84 unit & integration tests passed** (10.55s) | ✅ PASS |
...
| **ACES Health Classifier** | Multi-class health F1 | **87.16% Acc / 80.57% Balanced Acc** on held-out flights | ✅ VALIDATED |
...
| **RUL Estimator** | Degradation trajectory horizon | **Dual-mode: Polynomial trend + stress extrapolation** | ⚠️ DEMONSTRATOR |
...
| :--- | :--- | :--- | :--- | :--- |
| `aces_health.joblib` | `RandomForestClassifier` | Real ACES UAV flight missions | `n_estimators=100`, `max_depth=16` | Held-out flight `GroupShuffleSplit` (20%) |
...
| `RULService` | Hybrid Trend + Stress Model | Continuous degradation trajectories | Weibull parameters ($\beta=2.4, \eta=2200$) | Replay trajectory tracking |
